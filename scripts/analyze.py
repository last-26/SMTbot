...
def _render_rejected_counterfactual(
    ...
    if not pegged:
        lines.append("_No pegged (WIN/LOSS) rejects — counter-factual pegger was removed in the 2026-04-26 post-migration cleanup; pre-migration rows still carry stamps, post-migration rows are NULL until a Bybit-native pegger is written._")
        return lines
