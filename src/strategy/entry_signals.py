...
# 2026-05-05 v3 � Yol A cleanup: build_trade_plan_from_state +
# build_trade_plan_with_reason deleted (legacy 5-pillar plan
# builder, ~470 lines). HA-native dispatcher in
# src/strategy/ha_native_planner.py is the only entry path.
# evaluate_pending_invalidation_gates + helper gates kept (still
# called from runner._maybe_invalidate_pending_for).
